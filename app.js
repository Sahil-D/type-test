...
function randomParagraph() {
  ...
  // sahil -> <span>s</span><span>a</span><span>h</span><span>i</span><span>l</span>
...
function initTyping() {
  ...
  if (characterIndex < characters.length - 1 && timeLeft > 0) {
    ...
    // (correctly typed letters) / avg word len => avg no of correct words
    // time lapsed in sec / 60 -> time lapsed in min
